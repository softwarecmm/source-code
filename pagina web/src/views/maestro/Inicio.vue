    ...
    <div>
      <v-app-bar app color="white">
            <v-tabs align-with-title >
                <v-tab link to="/maestro/materias">Materias</v-tab>
                <v-tab link to="/maestro/informacion">Información</v-tab>
            </v-tabs>
...
export default {
  ...
  async created() {
      try {
        ...
        this.anuncios=response.data.filter(item => item.destinatario=='maestros' || item.destinatario=='todos')
      } catch (error) {
        console.error(error);
      }
  },
