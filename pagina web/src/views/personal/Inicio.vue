    ...
    <div>
      <v-app-bar app color="white">
            <v-tabs align-with-title >
                <v-tab link to="/personal/ingresos">Ingresos</v-tab>
                <v-tab link to="/personal/pagos">Pagos</v-tab>
            </v-tabs>
...
export default {
  ...
  async created() {
      try {
        ...
        this.anuncios=response.data.filter(item => item.destinatario=='personal' || item.destinatario=='todos' )
      } catch (error) {
        console.error(error);
      }
  },
